...
export const metadata = {
  title: 'Crear startup en Argentina sin capital — Escala',
  description: 'La plataforma para crear empresas en Argentina sin dinero inicial. El equipo trabaja por participacion, los inversionistas aportan capital por item. Sin deuda, sin banco.',
  keywords: ['startup Argentina', 'crear empresa Argentina sin capital', 'emprendimiento Argentina', 'financiacion startups Argentina', 'inversores angel Argentina'],
}
const s = {
...
export default function Page() {
  return (
    <div style={s.page}>
      <div style={s.hero}>
        <div style={{ fontSize: '0.75rem', fontWeight: '700', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#1D9E75', marginBottom: '1rem' }}>Escala · Argentina</div>
        <h1 style={s.h1}>Crea tu startup en Argentina<br/>sin necesitar capital propio.</h1>
      ...
      <div style={s.wrap}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: '1rem', marginBottom: '4rem' }}>
          {[
            ...
            { titulo: 'Empresa real en Argentina', desc: 'Escala te guia en la constitucion de tu empresa como SA u otro tipo societario segun tus necesidades.' },
          ].map(c => (
        ...
        <div style={{ textAlign: 'center' }}>
          <h2 style={{ ...s.h2, textAlign: 'center' }}>Tu empresa en Argentina empieza hoy</h2>
