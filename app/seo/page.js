...
const BLOG_ARTICULOS = [
  ...
  { num: 7, titulo: 'Qué buscan los inversionistas ángeles inversionistas en etapa temprana', kw: 'angel investor startup', vol: 300, estado: 'pendiente', prioridad: '🟡 Media' },
...
const ACCIONES_ROI = [
  ...
  { num: 16, accion: 'Blog: qué buscan los inversionistas ángeles inversionistas', estado: false },
