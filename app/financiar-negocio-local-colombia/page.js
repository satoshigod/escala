      ...
      <section style={s.section} id="como-funciona">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          {[
            ...
            { num: '05', titulo: 'Cuando pagas la deuda, el negocio es tuyo', desc: 'Una vez que el inversionista recupera su capital más los intereses, entras a la fase de regalía (un pequeño porcentaje de tus ventas por unos meses más). Después de eso, el negocio es completamente tuyo.' },
          ].map(paso => (
      ...
      <section style={s.section}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          {[
            ...
            ['¿Puedo salir del contrato anticipadamente?', 'Sí. Puedes pagar de una sola vez la deuda pendiente más una penalidad del 4% del total de arriendos del año si estás en la fase de repago, o el 8% si estás en la fase de regalía. Eso te deja completamente libre.'],
