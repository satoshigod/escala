...
export default async function sitemap() {
  ...
  const estaticas = [
    ...
    { url: `${BASE_URL}/blog/como-conseguir-maquina-confeccion-sin-banco`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/leasing-maquinaria-industrial-colombia`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/como-abrir-salon-belleza-sin-capital`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/negocio-comida-casa-colombia`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/diferencia-leasing-credito-maquinaria`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/como-ganar-dinero-confeccion-medellin`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/angel-investor-colombia-que-es`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/como-escalar-negocio-sin-prestamo`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/trabajar-desde-casa-confeccion-colombia`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${BASE_URL}/blog/equipo-belleza-financiado-medellin`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
