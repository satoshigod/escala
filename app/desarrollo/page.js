...
const fases = [
  ...
  },
  {
    ...
    hitos: [
      ...
      { num: '17.6', nombre: 'Dominio propio verificado con DKIM/SPF/DMARC en Resend — infraestructura de envío transaccional', done: true, valor: 1000000, quien: 'Fundador' },
