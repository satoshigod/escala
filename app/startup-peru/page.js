...
export default function Page() {
  return (
    <div style={s.page}>
      <div style={s.hero}>
        <div style={{ fontSize: '0.75rem', fontWeight: '700', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#1D9E75', marginBottom: '1rem' }}>Escala · Perú</div>
        <h1 style={s.h1}>Crea tu startup en Perú<br/>sin necesitar capital propio.</h1>
      ...
      <div style={s.wrap}>
        ...
        <div style={{ textAlign: 'center' }}>
          <h2 style={{ ...s.h2, textAlign: 'center' }}>Tu empresa en Perú empieza hoy</h2>
