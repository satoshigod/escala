...
const CAPAS = [
  ...
  },
  {
    ...
    hitos: [
      ...
      { num: 'C2.23', nombre: 'Reputacion post-proyecto: calificacion mutua al cerrar (1-5 estrellas + comentario). Score se actualiza con resultado real del proyecto cerrado', done: false, valor: 3000000, quien: 'Claude AI' },
      ...
      { num: 'C2.30', nombre: 'BENCHMARK: Renombrar flujos a lenguaje del emprendedor. "Negocio en local comercial" → "Necesito un local para mi negocio". "Presupuesto e inversion" → "Necesito equipos o maquinaria". Punto de entrada claro en home y en crear proyecto con iconos visuales. (Leccion: Duckfund, Shopify Capital — nunca usan lenguaje financiero)', done: false, valor: 500000, quien: 'Claude AI' },
      { num: 'C2.31', nombre: 'BENCHMARK: Calculadora interactiva en wizard local comercial. Antes de comprometerse, el emprendedor ve: "Con un arriendo de $X necesitas $Y para arrancar. Si vendes $Z al dia, pagas todo en N meses." Slider ajustable en tiempo real. (Leccion: Clearco — mostrar el numero exacto antes de pedir datos)', done: false, valor: 2000000, quien: 'Claude AI' },
      { num: 'C2.32', nombre: 'BENCHMARK: Buscador de equipos por nombre en el flujo de presupuesto. El emprendedor escribe "horno", "maquina de coser", "servidor", "nevera" y el sistema sugiere la categoria correcta automaticamente. Eliminar que tenga que elegir CAPEX/OPEX sin saber que significa. (Leccion: Crest Capital — 1 campo, no 10)', done: false, valor: 1500000, quien: 'Claude AI' },
      { num: 'C2.33', nombre: 'BENCHMARK: Timeline visible de cuanto tarda el dinero. Despues de publicar su necesidad, el emprendedor ve: "Dia 1: Tu proyecto esta visible — Dia 3: Primer angel interesado — Dia 7: Capital disponible (si hay acuerdo)". Expectativas claras desde el inicio. (Leccion: Duckfund — "fondos en 48h" como promesa central)', done: false, valor: 500000, quien: 'Claude AI' },
      { num: 'C2.34', nombre: 'BENCHMARK: Tres opciones visuales simples para el modelo de retorno del inversionista. En vez de formulario tecnico, mostrar: 🤝 "El angel tiene X% de mi negocio" | 💰 "Le pago $X al mes por Y meses" | 📊 "Le doy X% de mis ventas". Con ejemplo concreto de cada uno. (Leccion: Pipe/Capchase/Clearco — el modelo no dilutivo explicado en 1 linea)', done: false, valor: 1000000, quien: 'Claude AI' },
      { num: 'C2.35', nombre: 'BENCHMARK: Notificacion proactiva a angeles compatibles. Cuando un emprendedor publica un equipo o local, el sistema notifica automaticamente a los angeles del directorio que han fondeado proyectos similares (mismo sector, rango de monto, ciudad). No esperar a que el angel entre al directorio. (Leccion: Shopify Capital — el capital aparece cuando lo necesitas, sin que tengas que buscarlo)', done: false, valor: 1000000, quien: 'Claude AI' },
      { num: 'C2.36', nombre: 'BENCHMARK: Simplificar wizard local comercial a 3 preguntas maximas antes de mostrar el monto. Solo pedir: nombre del negocio, que vende, ciudad. Calcular el monto requerido con esos datos. Pedir el resto despues de que el emprendedor vea el numero y diga si. (Leccion: Duckfund — "aplica en 1 minuto")', done: false, valor: 2000000, quien: 'Claude AI' },
    ]
  },
  {
    id: 'C3',
    ...
    hitos: [
      ...
      { num: 'C3.25', nombre: 'BENCHMARK: Financiamiento embebido en el workspace, no como modulo separado. El widget de presupuesto/fondeo debe aparecer contextualmente cuando el fundador esta en el paso correcto del proyecto, no solo en la pestana de Presupuesto. (Leccion: Shopify Finance — el capital esta dentro del dashboard, no en un producto separado)', done: false, valor: 2000000, quien: 'Claude AI' },
      { num: 'C3.26', nombre: 'BENCHMARK: Panel del angel mas rico — mostrar el retorno esperado en pesos y porcentaje, no solo el monto invertido. El angel ve: "Invertiste $5M. Si el negocio funciona segun proyeccion, recuperas $8.5M en 18 meses (70% retorno)". (Leccion: Clearco/Pipe — el retorno total siempre visible antes de firmar)', done: false, valor: 1500000, quien: 'Claude AI' },
    ]
  },
  {
    id: 'C4',
  ...
  },
  {
    ...
    hitos: [
      ...
      { num: 'C5.9', nombre: 'Sistema para que ningun proyecto encuentre pantalla vacia: mostrar perfil de Escala como temporal, notificar internamente, activar reclutamiento del perfil faltante', done: false, valor: 3000000, quien: 'Claude AI' },
