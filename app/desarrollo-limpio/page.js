...
const CAPAS = [
  ...
  },
  {
    ...
    hitos: [
      ...
      { num: 'C11.15', nombre: 'Escalamiento (Tomo 9): Ronda 1: 10 maquinas Ivan Medellin confeccion → Ronda 2: 20 maquinas Ivan+1 angel Medellin+Bogota → Ronda 3: 50 maquinas multiples angeles 5 ciudades 3 sectores (zapateria, panaderia, carpinteria) → Ronda 4: plataforma autoescalable angeles buscan proyectos solos.', done: false, valor: 2000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.16', nombre: 'KPIs y optimizacion semanal (Tomo 9): si CTR < 2% dia 3 cambiar hook. Si CPL > $25K revisar segmentacion. Si landing < 5% revisar headline. Si WhatsApp < 40% revisar confirmacion. Dashboard semanal de metricas. El exito define el modelo para todas las verticales siguientes.', done: false, valor: 200000, quien: 'Claude AI + Ivan' },
    ]
  },
]
