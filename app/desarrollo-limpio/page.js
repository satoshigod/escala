...
const CAPAS = [
  ...
  },
  {
    ...
    descripcion: 'Campana viral modelo concurso publico. Escasez real: Ivan es el angel que financia 10 maquinas de confeccion para las mejores confeccionistas de Medellin. Meta 500+ aplicantes, 50 finalistas publicas, votacion, 10 ganadoras heroinas. Las ganadoras no son beneficiarias — son campeonas. Su historia es el activo de la segunda campana.',
    color: '#D946EF',
    estado: 'pendiente',
    valor_total: 15000000,
    valor_hecho: 1000000,
    hitos: [
      { num: 'C11.1', nombre: 'Landing /maquinaria-confeccion-medellin: CREADA. Hero: Tienes los pedidos. Te falta la maquina. Te la conseguimos. 3 pasos, ejemplo real con Maria y overlock $8.5M, 6 tipos de maquinas con marcas, CTA WhatsApp, FAQ. En sitemap prioridad 0.95.', done: true, valor: 1000000, quien: 'Claude AI' },
      { num: 'C11.2', nombre: 'Mecanica del concurso: marco mental gana tu maquina no pidas tu maquina. Escasez real (Ivan financia exactamente 10). Concurso publico en 5 semanas: aplicaciones → 50 finalistas anunciadas → votacion publica → 10 ganadoras en vivo.', done: false, valor: 0, quien: 'Ivan + Claude AI' },
      { num: 'C11.3', nombre: 'Contador publico en landing: X aplicantes · 10 cupos. Tiempo real. Se cierra al llegar a 500 aplicantes o cumplir el plazo. Genera urgencia genuina — no artificial.', done: false, valor: 500000, quien: 'Claude AI' },
      { num: 'C11.4', nombre: 'Formulario de aplicacion con score automatico: nombre, ciudad, tipo de maquina, pedidos mensuales actuales, capacidad actual vs capacidad con maquina nueva. Score de viabilidad 0-100. WhatsApp inmediato al enviar.', done: false, valor: 800000, quien: 'Claude AI' },
      { num: 'C11.5', nombre: 'Meta Ads TOFU: hook Solo 10 maquinas para las mejores confeccionistas de Medellin. Cual va a ser la tuya? 3 creativos video 30s. Segmentacion: mujeres 25-50, Medellin y Valle de Aburra, confeccion / ropa interior / vestidos de bano.', done: false, valor: 2000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.6', nombre: 'Meta Ads MOFU: retargeting 50%+ video. Mostrar mecanica del concurso y que Ivan es el angel real. X aplicantes ya compiten — tu todavia puedes aplicar.', done: false, valor: 1000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.7', nombre: 'Meta Ads BOFU: retargeting landing sin aplicar. Historia de una aplicante real en la ronda anterior. Quedan X dias para aplicar.', done: false, valor: 1000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.8', nombre: 'Semana 3 — Anuncio publico de las 50 finalistas con nombre, ciudad y tipo de maquina en Instagram. Cada finalista comparte que llego a la final. Sus redes y clientas amplifican sin costo.', done: false, valor: 500000, quien: 'Ivan + Claude AI' },
      { num: 'C11.9', nombre: 'Semana 4 — Las 50 finalistas entregan video 60s contando su historia. Votacion publica Instagram (30% del criterio). Otros 70%: pedidos verificados + viabilidad. Videos circulan solos en grupos de confeccionistas y WhatsApp.', done: false, valor: 1000000, quien: 'Ivan + Claude AI' },
      { num: 'C11.10', nombre: 'Semana 5 — Instagram Live: anuncio de las 10 ganadoras. Las 10 firman su proyecto en Escala esa semana. Ivan aprueba el leasing de cada maquina. Momento de maximo impacto mediatico de toda la campana.', done: false, valor: 500000, quien: 'Ivan' },
      { num: 'C11.11', nombre: 'Mes 2-3 — Entregar cada maquina en video. Primera produccion con la maquina nueva. Primeros pedidos cumplidos. Numeros reales: producia X, ahora produce Y, paga Z al mes. Este contenido es la segunda campana.', done: false, valor: 2000000, quien: 'Ivan + Claude AI' },
      { num: 'C11.12', nombre: 'WhatsApp flow 5 semanas: confirmacion → educacion → notificacion si pasa a finalistas → recordatorio votacion → resultado. Mantener enganchadas a las 500 aplicantes durante todo el proceso.', done: false, valor: 1000000, quien: 'Claude AI' },
      { num: 'C11.13', nombre: 'Contenido organico 30 piezas: dia a dia de confeccionista, cuanto gana, cuanto podria ganar, detras de camaras del concurso, presentacion de finalistas, anuncio de ganadoras. Instagram + TikTok.', done: false, valor: 1000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.14', nombre: 'Google Ads intencion de compra: maquina de coser industrial Medellin, maquina overlock precio Colombia, como comprar maquina sin credito. Capturar a quien ya busca activamente.', done: false, valor: 1000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.15', nombre: 'Segunda campana: 10 historias reales como creativos. ROI medido. Cara real. Expansion a otros sectores (zapateria, panaderia, carpinteria) y ciudades con el mismo modelo de concurso publico.', done: false, valor: 2000000, quien: 'Claude AI + Ivan' },
      { num: 'C11.16', nombre: 'KPIs: meta 500+ aplicantes en 2 semanas, CTR 3%+, CPL menos de $15.000 COP, conversion landing 8%+. El exito de esta campana define el modelo para todas las siguientes verticales.', done: false, valor: 200000, quien: 'Claude AI + Ivan' },
    ]
  },
]
      ...
      <div style={s.header}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'flex-end' }}>
            <a href="/desarrollo" style={{ fontSize: '0.75rem', color: '#6B7280', textDecoration: 'none' }}>Ver historico →</a>
