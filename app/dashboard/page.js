    ...
    <div style={{minHeight:'100vh',background:'#0D1B3E',fontFamily:'Inter,sans-serif'}}>
      ...
      <main style={{maxWidth:'1000px',margin:'0 auto',padding:'2rem 1.25rem'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))',gap:'1.25rem',marginBottom:'2rem'}}>
          ...
          <a href="/score" style={{textDecoration:'none',display:'block',background:'rgba(83,74,183,0.06)',border:'1px solid rgba(83,74,183,0.2)',borderRadius:'14px',padding:'1.5rem',transition:'border-color 0.2s'}} onMouseOver={e=>e.currentTarget.style.borderColor='rgba(83,74,183,0.5)'} onMouseOut={e=>e.currentTarget.style.borderColor='rgba(83,74,183,0.2)'}>
            <div style={{fontSize:'1.5rem',marginBottom:'0.75rem'}}>⭐</div>
            <div style={{fontSize:'0.95rem',fontWeight:'700',color:'#fff',marginBottom:'0.3rem'}}>Mi Escala Score</div>
            <div style={{fontSize:'0.78rem',color:'#8FA3CC',marginBottom:'1rem',lineHeight:'1.5'}}>Tu reputación verificable en la plataforma</div>
            <div style={{fontSize:'0.78rem',color:'#AFA9EC',fontWeight:'600'}}>Ver mi score →</div>
          </a>
