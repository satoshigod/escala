...
export const SEGMENTOS_ROLES = {
  ...
  'Abogado': {
    'Fundacional': [
      { nombre: 'Redactar estatutos sociales', descripcion: 'Documento base que define el objeto social, capital, órganos de gobierno y reglas de la empresa. Aplica para cualquier tipo de sociedad en cualquier país.', categoria: 'Legal', horas: 8 },
      { nombre: 'Redactar pacto de socios', descripcion: 'Acuerdo privado entre los aportantes sobre derechos, obligaciones, vesting, dilución y reglas de salida. Documento estratégico independiente del país.', categoria: 'Legal', horas: 10 },
      { nombre: 'Redactar acuerdo de confidencialidad del equipo fundador', descripcion: 'NDA entre todos los miembros del equipo para proteger la información del proyecto desde el inicio.', categoria: 'Legal', horas: 3 },
      { nombre: 'Redactar acuerdo de cesión de propiedad intelectual del equipo fundador', descripcion: 'Cada miembro del equipo fundador cede a la empresa los derechos sobre su trabajo, previo a la constitución formal.', categoria: 'Legal', horas: 4 },
      { nombre: 'Definir y documentar la estructura accionaria inicial', descripcion: 'Tabla de capitalización inicial con porcentajes, vesting schedules y condiciones de cada fundador.', categoria: 'Legal', horas: 5 },
      { nombre: 'Revisar y validar el nombre comercial', descripcion: 'Verificación de disponibilidad del nombre en registros mercantiles y bases de marcas del país.', categoria: 'Legal', horas: 2 },
    ],
  ...
  'Contador': {
    'Fundacional': [
      { nombre: 'Definir estructura de capital inicial', descripcion: 'Distribución del capital entre los socios fundadores, valoración inicial y tabla de capitalización. Aplica para cualquier país.', categoria: 'Finanzas', horas: 4 },
      { nombre: 'Crear plan de cuentas contable inicial', descripcion: 'Estructura contable adaptada al modelo de negocio del proyecto bajo estándares NIIF o GAAP según el país.', categoria: 'Finanzas', horas: 5 },
      { nombre: 'Definir política de gastos y control interno', descripcion: 'Reglas para aprobación de gastos, niveles de autorización y controles básicos desde el inicio de operaciones.', categoria: 'Finanzas', horas: 4 },
      { nombre: 'Proyección financiera de los primeros 12 meses', descripcion: 'Estado de resultados proyectado, flujo de caja y punto de equilibrio para el primer año de operación.', categoria: 'Finanzas', horas: 8 },
      { nombre: 'Diseñar estructura tributaria óptima', descripcion: 'Análisis del régimen tributario más conveniente según el modelo de negocio, independiente del país.', categoria: 'Finanzas', horas: 4 },
    ],
