...
export const COLOR_POR_PRIORIDAD = {
  ...
  // ---- Módulo 24 — Motor Financiero: Wallet (CRÍTICAS — no desactivables) ----
  wallet_fondeo_acreditado: {
    modulo: 'finanzas', categoria: 'finanzas', prioridad: 'critica',
    canales: ['email', 'in_app', 'push'],
    icon: '💰',
    titulo: 'Saldo acreditado',
    mensaje: (d) => `+${d.monto_formateado} en tu wallet. Nuevo saldo: ${d.saldo_formateado}.`,
    link: () => '/wallet',
  },
  wallet_debito_ejecutado: {
    ...
    canales: ['email', 'in_app', 'push'],
    icon: '💳',
    titulo: 'Débito ejecutado',
    mensaje: (d) => `-${d.monto_formateado} de tu wallet. Ref: ${d.numero_referencia}. Saldo: ${d.saldo_formateado}.`,
    link: () => '/wallet',
  },
